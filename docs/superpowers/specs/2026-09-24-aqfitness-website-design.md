...
4. **Program snapshot:** 8+ participants per team · 12+ weeks (12 minimum; programs can run 16, 20 weeks or longer) · 1:1 + team coaching · "We handle the day-to-day, so HR doesn't take on extra work." Closes with "Support that stays out of the way" and its one-line subtitle.
